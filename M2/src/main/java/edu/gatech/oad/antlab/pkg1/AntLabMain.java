 ...
 public class AntLabMain {
    ...
    public void printOutMessage() {
        ...
        String toPrint =
		  ...
		  Person1 p1 = new Person1("William Wu");
		  toPrint += p1.toString("wwu321");
		  //Person2 replace P2 with your name
		  //and gburdell with your gt id
		  Person2 p2 = new Person2("Ally Liu");
		  toPrint += p2.toString("allyliu");
		  //Person3 replace P3 with your name
		  //and gburdell3 with your gt id
		  Person3 p3 = new Person3("Jungwon Kang");
		  toPrint += p3.toString("jkang323");
                  //Person4 replace P4 with your name
                  //and gburdell4 with your gt id
                  Person4 p4 = new Person4("Daniel Holliday");
                  toPrint += p4.toString("dholliday3");
                  //Person5 replace P4 with your name
                  //and gburdell5 with your gt id
                  Person5 p5 = new Person5("Jason Liang");
                  toPrint += p5.toString("jliang87");
